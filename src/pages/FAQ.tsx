    ...
    items: [
      {
        ...
        a: "Каждый минерал обладает уникальной кристаллической структурой и частотой вибрации. При контакте с телом камень взаимодействует с энергетическим полем, помогая гармонизировать работу энергетических центров. Это не замена медицине — это дополнительный инструмент для работы с эмоциональным и энергетическим состоянием.",
      },
      {
