...
import { ArrowLeft, Sparkles, Shield, Heart, Eye, Star, Zap, BookOpen, Users, Flame, Moon } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    price: "500 ₽",
    badge: null,
    description: "Каждая медитация посвящена определённой теме: заземление, раскрытие сердца, активация интуиции, привлечение изобилия. Вы получаете: инструкцию по подготовке камней, практический гайд и запись медитации.",
    includes: [
      "Инструкция по подготовке и расположению камней",
      "Практический гайд по медитации",
      "Аудиозапись медитации",
    ],
