...
import { ArrowLeft, Sparkles, Shield, Heart, Eye, Star, Zap, Flame, Moon, Droplets } from "lucide-react";
...
const services = [
  ...
  },
  {
    ...
    price: "8 000 ₽",
    badge: null,
    description: "Индивидуальный подбор минералов, исключительно на основе вашей личной диагностики и конкретных запросов. Каждый набор формируется с учётом совместимости минералов между собой и с вашей уникальной энергетикой.",
    includes: [
  ...
  },
  {
    ...
    price: "по запросу",
    badge: "Новое",
    description: "Агнихотра — ведическое огненное очищение, проводимое строго на восходе и закате солнца. Ягья — расширенный огненный ритуал с мантрами, направленный на конкретное намерение: здоровье, процветание, защита рода, исцеление отношений. Проводится лично или дистанционно с передачей фото- и видеоотчёта.",
    includes: [
  ...
  },
  {
    ...
    price: "3 000 ₽",
    badge: null,
    description: "Дистанционная работа по фото для снятия тяжёлых энергетических наложений, испугов, тревоги и повторяющихся блок-сценариев в жизни.",
    includes: [
      "Сглазы, порчи, чужие наложения",
      "Испуги, страхи, панические и тревожные состояния",
      "Хроническая усталость и туман в голове",
      "Злость, обиды, тяжёлые отношения",
  ...
  },
  {
    ...
    price: "5 000 ₽",
    badge: null,
    description: "Глубокая чистка от эмоционального перенапряжения, тревожного фона, энергетических засоров и привязок к тяжёлым прошлым сценариям.",
    includes: [
      "Эмоциональное перенапряжение, злость и вспышки",
      "Тяжёлые переживания и привязки к прошлому",
  ...
  },
  {
    ...
    includes: [
      ...
      "Сопровождение к осознанной и устойчивой Реализации",
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Задача мастера — увидеть, что мешает потоку, и помочь убрать это с пути. Камни, огонь, работа с Родом — инструменты разные, цель одна: ваша внутренняя свобода и Реализация.
                </p>
                <div className="mt-4">
                  <a
