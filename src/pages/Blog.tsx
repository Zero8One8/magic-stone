...
const articles = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p" as const, text: "Пока каждый не встречается с этой болью лицом к лицу, не признает ее и не проживает, внутреннее напряжение может накапливаться и проявляться в повторяющихся сценариях." },
      ...
      { type: "p" as const, text: "Зависть возникает, когда индивид теряет контакт с собственной ценностью и живет через сравнение. Это истощает, усиливает тревогу и мешает видеть свои достижения." },
