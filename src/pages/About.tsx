        ...
        <AnimateOnScroll>
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              энергетического состояния и индивидуальный подбор минералов для восстановления
        ...
        <AnimateOnScroll>
          <div className="max-w-4xl mx-auto bg-card rounded-2xl border border-border p-8 md:p-12">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <p>
                Каждая душа — это уникальная энергетическая система. Камни не являются волшебной
              ...
              <p>
                ...
                и с вашей уникальной энергетикой.
              </p>
            </div>
          </div>
        </AnimateOnScroll>
          ...
          {[
            ...
            },
            {
              ...
              text: "Нет универсальных рецептов. То, что помогает одному человеку, может быть бесполезно для другого. Поэтому каждый набор камней формируется исключительно под конкретного человека, с учётом его текущего состояния, задач и особенностей энергетики.",
                          text: "Нет универсальных рецептов. Каждый набор камней формируется исключительно под конкретный запрос, с учётом текущего состояния, задач и особенностей энергетики.",
            },
            {
              icon: Shield,
